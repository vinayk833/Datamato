...
%>
			...
			<TD><input type="text" id="v1" name="hours" pattern="[0-9]+([\.,][0-9]+)?" value="<%=request.getAttribute("hours")%> " style="width:80px;"/></TD>
...
<br><br>
<input type="submit" value="Update" style="margin-left: 0%;width:80px;height:32px;background-color:#007BC0;color:white" onclick="form.action='<%=request.getContextPath()%>/DirectorUpdateTask?status=Reupdate';return validation2(this)" />
...
//**Should I input the codes here?**
	...
	con.close();
	System.out.println("Disconnected grom Db in UI");
}
%>
    </form>
</body>
