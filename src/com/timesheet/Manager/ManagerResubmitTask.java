...
/**
 * Servlet implementation class ManagerResubmitTask
 */
@WebServlet("/ManagerResubmitTask")
public class ManagerResubmitTask extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static String mydate = null;
       
   
    public ManagerResubmitTask() {
        super();
           ...
           String query = "SELECT taskId,EmployeeID,date,ProjName,proid,TaskCat,description,hours,approval from task where approval='Rejected' AND EmployeeID='" + employeeID + "'";		
	         ...
	         String sum = null;		
				...
				request.setAttribute("Totalhour",sum);		
	             ...
	             RequestDispatcher view = request.getRequestDispatcher("/ProjMag/ManagerResubmit.jsp");		
